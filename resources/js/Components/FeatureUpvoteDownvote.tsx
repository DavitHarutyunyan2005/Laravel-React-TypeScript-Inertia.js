...
export default function FeatureUpvoteDownvote({ feature }: { feature: Feature }) {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <span className={(feature.user_has_downvoted || feature.user_has_upvoted) ? "text-2xl font-semibold text-amber-600" : "text-2xl font-semibold"}>{feature.upvote_count}</span>
